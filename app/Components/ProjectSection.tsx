        ...
        {projects.map((project) => (
          <CardBody key={project.id} className="w-full p-4">
            ...
            <CardItem className="bg-white shadow-lg rounded-lg overflow-hidden p-5">
              ...
              <a href={project.link} className="visit-project-btn text-blue-500 mt-3 inline-block">
                Visit Project
              </a>
              <br />
              <a href={project.gitlink} className="visit-project-btn text-blue-500 mt-3 inline-block">
                GitHub Repo
              </a>
            </CardItem>
          </CardBody>
